...
@section('title', 'Ubah Data Master Product')

@section('breadcrumb_1', 'Data')

@section('href_breadcrumb_1', route('master-product.index'))

@section('breadcrumb_2', 'Ubah Data Master Product')
    ...
    <div class="container">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i
                            data-feather="plus"></i></span></span>Ubah Data Master Product</h4>
        </div>
        <!-- /Title -->
                        ...
                        <div class="col-sm">
                            <form id="form">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="id" value="{{ base64_encode($data->ProductPK) }}">
                                    <input type="text" class="form-control"
                                        id="ProductName" name="ProductName"
                                        autocomplete="off"
                                        placeholder="Contoh : Product 1"
                                        minlength="3" maxlength="150"
                                        value="{{ $data->ProductName }}"
                                        required>
                                    <span class="text-danger" id="error-ProductName"></span>
                                </div>
        ...
        $('#form').submit(function(e) {
            ...
            Swal.fire({
                    ...
                    preConfirm: () => {
                        return $.ajax({
                            method: 'PUT',
                            url: "{{ route('master-product.update', '') }}/" + id,
                            type: 'JSON',
                            headers: {
