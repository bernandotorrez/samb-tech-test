...
@section('breadcrumb_2', 'Ubah Password Pengguna')
    ...
    <div class="container">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i
                            data-feather="edit"></i></span></span>Ubah Password Pengguna</h4>
        </div>
        <!-- /Title -->
...
@push('scripts')
    ...
    <script text="type/javascript">
        ...
        $('#form').submit(function(e) {
            ...
            if(password.trim() == '') {
                $('#error-password').text('Isi Password')
            } else {
                $('#error-password').text('')
            }
            ...
            if(password.trim() != '') {
                Swal.fire({
                    ...
                    preConfirm: () => {
                        return $.ajax({
                            method: 'POST',
                            url: "{{ route('user.update-password') }}/"+uuid_user,
                            type: 'JSON',
                            headers: {
