...
@section('breadcrumb_2', 'Data Pengguna')
    ...
    <div class="container">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i
                            data-feather="users"></i></span></span>Daftar Pengguna</h4>
        </div>
        <!-- /Title -->
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <a class="btn btn-primary mb-3" type="submit" id="button-submit"
                                href="{{ route('user.create') }}">Tambah Data</a>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="feather-icon"
                                                        href="{{ route('user.edit', ['id' => $row->uuid_user]) }}">
                                                        <i data-feather="edit" class="text-success"></i>
                                                    </a>
                                                    &nbsp;
                                                    <a class="feather-icon"
                                                        href="{{ route('user.edit-password', ['id' => $row->uuid_user]) }}">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                            class="feather feather-key text-warning">
                                                            <path
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function deleteData(el) {
            var uuid = el.getAttribute('data-id')
