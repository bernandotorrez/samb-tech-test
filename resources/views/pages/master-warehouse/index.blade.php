...
@section('breadcrumb_2', 'Master Warehouse')
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <a class="btn btn-primary mb-3" type="submit" id="button-submit"
                                href="{{ route('master-warehouse.create') }}">Tambah Data</a>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="feather-icon"
                                                        href="{{ route('master-warehouse.edit', ['master_warehouse' => base64_encode($row->WhsPK)]) }}">
                                                        <i data-feather="edit" class="text-success"></i>
                                                    </a>

                                                    &nbsp;
                                                    <a class="feather-icon"
                                                        data-id="{{ base64_encode($row->WhsPK) }}"
                                                        data-name="{{ $row->WhsName }}"
        ...
        function deleteData(el) {
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return $.ajax({
                        method: 'DELETE',
                        url: "{{ route('master-warehouse.destroy', '') }}/" + id,
                        type: 'JSON',
                        headers: {
