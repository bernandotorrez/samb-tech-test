...
@section('title', 'Tambah Data Master Warehouse')

@section('breadcrumb_1', 'Data')

@section('href_breadcrumb_1', route('master-warehouse.index'))

@section('breadcrumb_2', 'Tambah Data Master Warehouse')
    ...
    <div class="container">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i
                            data-feather="plus"></i></span></span>Tambah Data Master Warehouse</h4>
        </div>
        <!-- /Title -->
