...
@section('breadcrumb_2', 'Master Customer')
...
@section('content')
    <div class="container">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" 
                ...
                <line x1="15" y1="9" x2="15.01" y2="9"></line></svg></span></span>Master Customer</h4>
        </div>
        <!-- /Title -->
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <a class="btn btn-primary mb-3" type="submit" id="button-submit"
                                href="{{ route('master-customer.create') }}">Tambah Data</a>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="feather-icon"
                                                        href="{{ route('master-customer.edit', ['master_customer' => base64_encode($row->CustomerPK)]) }}">
                                                        <i data-feather="edit" class="text-success"></i>
                                                    </a>

                                                    &nbsp;
                                                    <a class="feather-icon"
                                                        data-id="{{ base64_encode($row->CustomerPK) }}"
        ...
        function deleteData(el) {
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return $.ajax({
                        method: 'DELETE',
                        url: "{{ route('master-customer.destroy', '') }}/" + id,
                        type: 'JSON',
                        headers: {
                        ...
                        success: function(response) {
                            ...
                            Swal.fire({
                                ...
                                if (success) {
                                    window.location = "{{ route('master-customer.index') }}";
                                }
                            });
