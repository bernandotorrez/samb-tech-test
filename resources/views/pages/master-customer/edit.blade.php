...
@section('title', 'Ubah Data Master Customer')

@section('breadcrumb_1', 'Data')

@section('href_breadcrumb_1', route('master-customer.index'))

@section('breadcrumb_2', 'Ubah Data Master Customer')
    ...
    <div class="container">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i
                            data-feather="plus"></i></span></span>Ubah Data Master Customer</h4>
        </div>
        <!-- /Title -->
                        ...
                        <div class="col-sm">
                            <form id="form">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="id" value={{ base64_encode($data->CustomerPK) }}>
                                    <input type="text" class="form-control"
                                        id="CustomerName" name="CustomerName"
                                        autocomplete="off"
                                        placeholder="Contoh : Customer 1"
                                        minlength="3" maxlength="100"
                                        value="{{ $data->CustomerName }}"
                                        required>
                                    <span class="text-danger" id="error-CustomerName"></span>
                                </div>
        ...
        $('#form').submit(function(e) {
            ...
            Swal.fire({
                    ...
                    preConfirm: () => {
                        return $.ajax({
                            method: 'PUT',
                            url: "{{ route('master-customer.update', '') }}/" + id,
                            type: 'JSON',
                            headers: {
