...
@section('breadcrumb_2', 'Master Supplier')
    ...
    <div class="container">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i
                            data-feather="truck"></i></span></span>Master Supplier</h4>
        </div>
        <!-- /Title -->
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <a class="btn btn-primary mb-3" type="submit" id="button-submit"
                                href="{{ route('master-supplier.create') }}">Tambah Data</a>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="feather-icon"
                                                        href="{{ route('master-supplier.edit', ['master_supplier' => base64_encode($row->SupplierPK)]) }}">
                                                        <i data-feather="edit" class="text-success"></i>
                                                    </a>

                                                    &nbsp;
                                                    <a class="feather-icon"
                                                        data-id="{{ base64_encode($row->SupplierPK) }}"
        ...
        function deleteData(el) {
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return $.ajax({
                        method: 'DELETE',
                        url: "{{ route('master-supplier.destroy', '') }}/" + id,
                        type: 'JSON',
                        headers: {
