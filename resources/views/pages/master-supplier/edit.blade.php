...
@section('title', 'Ubah Data Master Supplier')

@section('breadcrumb_1', 'Data')

@section('href_breadcrumb_1', route('master-supplier.index'))

@section('breadcrumb_2', 'Ubah Data Master Supplier')
    ...
    <div class="container">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i
                            data-feather="plus"></i></span></span>Ubah Data Master Supplier</h4>
        </div>
        <!-- /Title -->
                        ...
                        <div class="col-sm">
                            <form id="form">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="id" value="{{ base64_encode($data->SupplierPK) }}">
        ...
        $('#form').submit(function(e) {
            ...
            Swal.fire({
                    ...
                    preConfirm: () => {
                        return $.ajax({
                            method: 'PUT',
                            url: "{{ route('master-supplier.update', '') }}/" + id,
                            type: 'JSON',
                            headers: {
